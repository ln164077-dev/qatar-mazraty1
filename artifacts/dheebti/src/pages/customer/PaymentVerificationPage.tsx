...
export function PaymentVerificationPage() {
  ...
  const [code, setCode] = useState(''); // حقل نصي فريد
        ...
        <div className="relative flex w-[340px] flex-col items-center justify-center gap-6 rounded-[22px] border-[5px] border-white bg-white p-6 shadow-[0px_0px_20px_rgba(0,0,0,0.082)] sm:w-[360px]">
          ...
          <div className="w-full">
            <input
              ...
              placeholder="••••••"
              autoFocus
              className="h-[52px] w-full rounded-[12px] bg-[rgb(228,228,228)] text-center text-xl font-semibold text-[rgb(44,44,44)] tracking-[8px] outline-none caret-[rgb(127,129,255)] transition-all duration-300 focus:bg-[rgba(127,129,255,0.199)] focus:shadow-none"
